# How to Monitor Brand Visibility in AI Engines in Hi, Moose
...
- **Claude**: Monitor your brand in Claude's answers
- **Perplexity**: Check if Perplexity cites your content
- **Gemini**: Track visibility in Google's Gemini AI
- **Grok**: Monitor mentions in X's AI assistant

Unlike traditional SEO tracking, LLM Beacon shows you **how AI systems respond** when users ask natural language questions. You'll see:

- **If your brand is mentioned** (domain or brand name appears)
- **If your content is cited** (AI includes URLs to your site)
- **What context surrounds your mentions** (full AI-generated responses)
...
- **Auditing AI search presence**: Understand your baseline visibility before launching campaigns
- **Tracking thought leadership**: Monitor if AI cites you as an authority in your niche
- **Competitive intelligence**: Discover what prompts trigger competitor mentions
...
- **Brand information configured** in your project:
  ...
  - Set this up in **Brand Voice** settings before adding prompts
...
LLM Beacon is **not available on Free plans**. This is a premium feature requiring paid subscriptions.

---

## Step-by-step (in Hi, Moose)

### 1. Navigate to LLM Beacon
- From your project dashboard, select **LLM Beacon** from the sidebar
- You'll see the Tracked Prompts overview

### 2. Configure Brand Information (First Time Only)
If you haven't set up your brand info yet:
- Click **"Add a New Prompt"**
- You'll see a prompt to configure your brand information
- Enter your **Brand Name** (e.g., "Acme Industries")
- Enter your **Domain** (e.g., "acmeindustries.com" or "https://www.acmeindustries.com")
  - Hi, Moose automatically normalizes domains (removes www, https://, trailing slashes)
...
**In the Add Prompt modal:**

**a) Review Your Brand**
- Confirm your brand name and domain are correct
- Click **"Edit"** if you need to change them
...
- Check the boxes for platforms you want to monitor:
  - **AI Overview** (Google's AI-generated answers)
...
Back on the main LLM Beacon page, you'll see:
- **Tracked Prompts count** (e.g., "Tracked Prompts (3)")
- **Credit usage** displayed at the top
- **List of your prompts** with:
  - The prompt text
  - Platforms being tracked (with status icons)
  - Last checked date
  - Expand/collapse controls

### 5. Check Initial Results
Within 1-3 minutes, your initial check completes. For each platform, you'll see one of these statuses:

**Status Icons:**
- **Spinning icon** (blue): Check in progress
- **Green checkmark**: Your brand was mentioned or cited
- **Red X**: Not mentioned
- **Yellow info icon** (AI Overview only): No AI Overview exists for this query (this is normal—not all queries trigger AI Overviews)
- **Gray dash**: No results yet

### 6. View Detailed Results
Click a platform icon to expand details:

**For prompts where you're mentioned/cited:**
- **Your mention/citation**: Shows the context where your brand appears, with your domain and brand name highlighted
- **Timestamp**: When the check ran
- **Full AI response**: The complete answer the AI provided
- **Competitors cited**: Other brands/domains mentioned in the same response

**For prompts where you're NOT mentioned:**
- **Status**: "Not mentioned"
- **Competitors cited**: Shows who IS being mentioned (competitive intelligence)
- **Full AI response**: The complete answer (so you can see what content/angle is preferred)

### 7. Analyze Competitive Intelligence
Scroll down to see **"Competitors Also Mentioned"**:
- Lists all other domains/brands cited by the AI
...
- Confirm deletion
- Credits are freed up immediately for reuse

**Note**: Deleting a prompt does **not** recover already-used monthly credits—it only stops future weekly checks and frees up your tracking slots.

---

## What you get

### 1. Brand Visibility Status
For each platform and prompt:
- **Mentioned**: Your domain or brand name appears in the AI's response
- **Cited**: AI includes a URL to your website
- **Not mentioned**: AI doesn't reference you at all

### 2. Full AI Responses
Complete text of what the AI generated, with:
- Your brand name **highlighted in green**
- Your domain **highlighted in blue**
- Full context showing how you're positioned

### 3. Competitor Intelligence
Lists of other brands/domains cited in the same AI response:
- Domain names
- Page titles (when available)
- See who you're competing against in AI search

### 4. Historical Tracking
Weekly snapshots showing:
- Changes in visibility over time
- When you gain or lose mentions
- Trends in competitor citations
...
### "You only have X credits remaining. Each platform requires 1 credit."
**Cause**: You're trying to track more platforms than you have credits for.  
**Solution**: 
- Uncheck some platforms to reduce credit usage
- Or delete existing prompts to free up credits
- Or upgrade your plan for more monthly credits

### "LLM Beacon tracking is a premium feature available on paid plans"
**Cause**: You're on a Free plan.  
**Solution**: Upgrade to Starter, Growth, or Enterprise to access LLM Beacon. Click **"View Plans & Pricing"** to see options.

### "Please configure your brand information first"
**Cause**: You haven't set up brand name and domain.  
**Solution**: 
- The modal will prompt you automatically
- Enter your brand name and domain
- Or visit **Brand Voice** settings to configure it manually
- Save and return to add your prompt

### Initial check stuck on "in progress" (spinning icon)
**Cause**: Checks typically take 1-3 minutes, but can occasionally take up to 5 minutes for complex queries.  
**Solution**: 
...
- Results save automatically even if your browser times out
- If still no results after 5 minutes, run another on-demand check

---

## FAQs

### How does Hi, Moose detect my brand?

Hi, Moose searches AI responses for:
- **Your domain** (e.g., "acmeindustries.com")—normalized to match with or without www, https://, etc.
- **Your brand name** (e.g., "Acme Industries")—case-insensitive matching

If either appears in the AI's response, we flag it as "mentioned." If a URL to your domain appears, we flag it as "cited."

### What's the difference between "mentioned" and "cited"?

**Mentioned**: Your brand name or domain appears in the AI's text response (e.g., "Acme Industries offers great software").

**Cited**: The AI includes a clickable URL to your website (e.g., "Check out acmeindustries.com/pricing").

**Best case**: Both mentioned AND cited—your brand is named and linked.
...
Each Hi, Moose project tracks **one brand** (configured in Brand Voice settings). To track multiple brands:
