...
1. Depuis **Connections → Grav** dans l'application de bureau, ouvrez le lien de téléchargement et récupérez l'archive ZIP du plugin Hi, Moose. La version actuelle est la **0.1.1** et elle nécessite Grav 1.7.0 ou supérieur.
...
1. Ouvrez **Connections** dans l'application de bureau et choisissez Grav.
...
5. Cliquez sur **Test connector** pour valider la connexion avec votre site Grav en production.
