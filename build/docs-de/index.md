...
!!! note "Moving from the web app?"
    Hi, Moose used to be a web-only product. As the desktop app becomes the primary surface, the legacy web app (`app.himoose.com`) is being narrowed down to two features that haven't moved over yet: **[Listen to this Article](legacy/listen-to-this-article.md)** (audio generation) and **[Versus Pages](legacy/versus-pages.md)** (programmatic comparison pages). Everything else — visibility monitoring, AEO audits, content briefs, FAQs, key points, drafting, publishing, and integrations — now lives in the desktop app.
...
1. **[Install & sign in](getting-started/install-and-sign-in.md)** — Download the desktop app and choose an account mode.
2. **[Understand account types & modes](getting-started/account-modes.md)** — Preview Mode, BYOK Free, BYOK Premium, and Paid Managed all work a little differently.
...
- **Local-first by design** — In BYOK modes, your data, memory, and model calls stay on your machine unless a feature explicitly requires a cloud step.
