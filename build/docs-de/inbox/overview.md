...
- **Site change detections** — critical, notable, or informational AEO-relevant changes found on your site, including batch summaries and unreachable-page alerts.
...
- **Publishing events** — a publish that succeeded or failed, or a change waiting on your approval.
...
Items are grouped by date (e.g. "Yesterday," "Older") with a count badge for each group, so you can quickly see how much is waiting for you.
