...
Debajo de los controles de rastreo está el **Índice de búsqueda**, el índice semántico local que Moose utiliza para responder preguntas sobre las páginas de su sitio. Indica cuántas páginas están indexadas, cuántos pasajes han producido esas páginas y cuándo se actualizó por última vez.
...
- **Reconstruir índice** vuelve a indexar desde cero.
...
Los niveles de impacto son **Crítico**, **Notable**, **Bajo**, **Inaccesible** y **Sin revisar**.
...
- **Severidad mínima de notificación del sistema operativo**: solo los elementos del Inbox iguales o superiores a este nivel muestran una notificación de escritorio. Póngalo en Info si quiere que los cambios de bajo impacto también aparezcan a nivel del sistema operativo.

## Preguntar a Moose qué ha cambiado

El resumen incluye una acción **Preguntar a Moose sobre todo esto** que entrega la instantánea completa del rastreo al chat y le pregunta qué es lo más importante y qué hacer primero. Las páginas individuales tienen su propia acción **Preguntar a Moose**, que pasa únicamente el cambio registrado de esa página.
...
Si no se puede acceder a una página o a todo el sitio, se informa como un tipo de cambio propio en lugar de descartarse en silencio. Una caída de todo el sitio produce un único elemento **Sitio inaccesible** en lugar de un aviso por página.
