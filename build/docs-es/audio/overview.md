...
!!! note "Traducción automática"
    ...
    [Leerla en inglés](https://himoose.com/docs/audio/overview/)
...
Audio vive en la aplicación de escritorio, en **Audio**, dentro de la barra lateral, y se divide en tres pestañas: **Generar**, **Historial** y **Analíticas**.
...
Defina primero el sitio web del proyecto. La reproducción está limitada al dominio de su proyecto y a `himoose.com`, de modo que Hi, Moose necesita conocer el dominio antes de generar nada. Si no está definido, la pestaña Generate muestra un aviso **Configurar sitio web** en lugar del compositor.
...
- **URL del artículo**: pegue una URL publicada y pulse **Obtener**. Hi, Moose extrae el contenido y muestra el dominio, el número de palabras y el tiempo estimado de lectura. El artículo debe ser accesible públicamente, no estar tras un inicio de sesión o un muro de pago.
...
**Enfoque** (opcional) orienta en qué debe profundizar la conversación. Hay sugerencias rápidas para los enfoques más habituales: conclusiones clave, explicarlo a alguien que empieza, rebatir el argumento, a quién le interesa.

**Duración** define la duración objetivo:
...
**Idioma** se ajusta de forma predeterminada al idioma del artículo. Cámbielo para modificar tanto el guion como las voces.

**Voces** se presentan como parejas de anfitrión e invitado, con tres combinaciones predefinidas (cálida y curiosa, serena y analítica, luminosa y escéptica) o una pareja personalizada elegida por usted.
...
Cuando tenga una configuración que le convenza, **Guardar como predeterminado del proyecto** la reutiliza en el siguiente episodio de este proyecto.

## Generar

Pulse **Generar audio**. El compositor muestra un tiempo estimado de renderizado antes de empezar. La generación se ejecuta en segundo plano, de modo que puede salir de la pantalla y seguir trabajando: el episodio terminado aparece en la lista **Recientes** de la barra lateral, y al pulsarlo se abre ese episodio directamente.
...
- **Descargar MP3**
- **Compartir**, para copiar el enlace del audio
- La **transcripción** completa, con recuento de turnos y de palabras, y un botón para copiarla
- **Insertar en su sitio**, que se explica en [Reproductor e inserción](player-and-embed.md)
- **Regenerar con cambios** y **Editar los ajustes**, para ajustar la dirección y volver a ejecutarlo

## History

La pestaña **Historial** enumera todos los episodios del proyecto actual con su duración, su fecha de creación y su estado. Los episodios se acotan por proyecto, de modo que cambiar de proyecto cambia lo que ve.

- Busque episodios por nombre
- Filtre por **Todos**, **Listo** o **Requiere atención**
