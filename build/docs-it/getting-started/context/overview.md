...
!!! note "Traduzione automatica"
    ...
    [Leggila in inglese](https://himoose.com/docs/getting-started/context/overview/)
...
Context si compone di quattro elementi:
...
| **[Documenti del brand](brand-documents.md)** | Per progetto | I suoi documenti di message house, guida di stile e posizionamento. Hi, Moose li suddivide in sezioni, applica le sue regole di scrittura a tutto e richiama il resto quando un lavoro ne ha bisogno. |
...
## Perché sono artefatti separati
...
I **Documenti del brand** contengono tutto il materiale di origine che sta dietro a entrambi. Brand Voice e Brand Truth Profile restano sintesi brevi. I suoi documenti conservano il dettaglio, e Hi, Moose vi cerca le sezioni adatte a ogni lavoro. Può anche usarli per compilare i due profili.

**Su di lei** si distingue da tutti questi: non riguarda affatto il marchio. È contesto personale su **di lei**, la persona che usa l'app, salvato in locale sul suo dispositivo invece di essere legato a un progetto. La accompagna quindi tra i progetti, invece di azzerarsi a ogni cambio di spazio di lavoro.
...
- **Documenti del brand** vengono riutilizzati nei Content Briefs, nelle bozze di articolo del blog, nei Key Points, nel generatore di FAQ, nella ricerca di [Send Moose](../../send-moose/overview.md) e nella [Chat](../../chat/overview.md), dove la chat può anche cercare al loro interno. Veda [Dove vengono usati i suoi documenti](brand-documents.md#dove-vengono-usati-i-suoi-documenti).
...
Ogni artefatto indica quanti campi ha compilato e mostra una breve anteprima non appena aggiunge qualcosa. Tutti i campi sono facoltativi: Hi, Moose funziona anche con un contesto parziale e diventa più preciso man mano che lei aggiunge dettagli.
...
Se ha già un message house o una guida di stile, lo carichi in [Documenti del brand](brand-documents.md) e faccia clic su **Compila i profili dai documenti**. Hi, Moose suggerisce valori sia per la Brand Voice sia per il Brand Truth Profile, ciascuno sostenuto da una citazione del suo documento, e lei sceglie quali applicare.

## Archiviazione locale e sincronizzazione in cloud

Per impostazione predefinita Brand Voice, Brand Truth Profile e Documenti del brand sono salvati **in locale per il progetto corrente**, mentre Su di lei è salvato **in locale sul suo dispositivo**. La sincronizzazione in cloud, che conserva Brand Voice, Brand Truth Profile e Documenti del brand e li condivide con il team, è disponibile in **tutti i piani a pagamento**, compresi i piani BYOK a pagamento. Preview Mode e BYOK Free restano solo locali; passando a un piano superiore si attiva la sincronizzazione, così il suo team condivide la stessa base ed essa è protetta se accade qualcosa alla sua macchina.
