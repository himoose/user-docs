...
!!! note "Traduzione automatica"
    ...
    [Leggila in inglese](https://himoose.com/docs/audio/overview/)
...
Audio si trova nell'app desktop sotto **Audio** nella barra laterale, diviso in tre schede: **Genera**, **Cronologia** e **Analisi**.
...
Imposti prima il sito del progetto. La riproduzione è limitata al dominio del suo progetto e a `himoose.com`, perciò Hi, Moose deve conoscere il dominio prima di generare qualsiasi cosa. Se non è impostato, la scheda Generate mostra l'invito **Imposta sito web** al posto dell'editor.
...
- **URL dell'articolo**: incolli una URL pubblicata e faccia clic su **Recupera**. Hi, Moose estrae il contenuto e mostra dominio, numero di parole e tempo di lettura stimato. L'articolo deve essere accessibile pubblicamente, non protetto da accesso o paywall.
...
**Durata** definisce la durata desiderata:
...
**Lingua** segue per impostazione predefinita la lingua dell'articolo. La modifichi per cambiare sia il copione sia le voci.

**Voci** si presentano come coppie di conduttore e ospite, con tre combinazioni predefinite (calda e curiosa, pacata e analitica, brillante e scettica) oppure una coppia personalizzata scelta da lei.
...
Quando trova impostazioni che la convincono, **Salva come predefinito del progetto** le riutilizza per il prossimo episodio di questo progetto.

## Generare

Faccia clic su **Genera audio**. L'editor mostra un tempo di elaborazione stimato prima di partire. La generazione avviene in background, quindi può lasciare la schermata e continuare a lavorare: l'episodio finito compare nell'elenco **Recenti** della barra laterale, e un clic lo apre direttamente.

Al termine ottiene:

- Un player con ricerca, salti di 15 secondi avanti e indietro e velocità di riproduzione
- **Scarica MP3**
- **Condividi**, per copiare il link dell'audio
- La **trascrizione** completa, con il conteggio dei turni di parola e delle parole, e un pulsante per copiarla
- **Incorpora nel suo sito**, descritto in [Player e incorporamento](player-and-embed.md)
- **Rigenera con modifiche** e **Modifica le impostazioni**, per ritoccare la regia ed eseguire di nuovo

## History

La scheda **Cronologia** elenca ogni episodio del progetto corrente con durata, data di creazione e stato. Gli episodi sono delimitati per progetto, quindi cambiare progetto cambia ciò che vede.

- Cerchi episodi per nome
- Filtri per **Tutti**, **Pronto** o **Richiede attenzione**
